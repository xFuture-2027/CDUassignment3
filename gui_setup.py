...
class GUISetup:
    ...
    def setup_menu(root, callbacks):
        ...
        file_menu.add_command(
            label="Open", 
            command=callbacks['open_image'], 
            accelerator="Ctrl+O"
        )
        file_menu.add_command(
            label="Save", 
            command=callbacks['save_image'], 
            accelerator="Ctrl+S"
        )
        file_menu.add_command(
            label="Save As", 
            command=callbacks['save_image_as'], 
            accelerator="Ctrl+Shift+S"
        )
        file_menu.add_separator()
        file_menu.add_command(
            label="Exit", 
            command=callbacks['exit_application']
        )
        ...
        edit_menu.add_command(
            label="Undo", 
            command=callbacks['undo_operation'], 
            accelerator="Ctrl+Z"
        )
        edit_menu.add_command(
    ...
    def setup_control_panel(root, callbacks, variables):
        ...
        action_frame = tk.Frame(control_frame, bg='#3c3c3c')
    ...
    def _setup_basic_filters_tab(notebook, callbacks, variables):
        ...
        tk.Button(
            basic_tab, 
            text="Grayscale", 
            command=callbacks['apply_grayscale'],
            bg='#007acc', 
            fg='black', 
        ...
        tk.Button(
            basic_tab, 
            text="Edge Detection", 
            command=callbacks['apply_edge_detection'],
            bg='#007acc', 
            fg='black', 
            activebackground='#005f9e',
            activeforeground='black',
    ...
    def _setup_adjustments_tab(notebook, callbacks, variables):
        ...
        brightness_slider = tk.Scale(
            ...
            to=100, 
            orient=tk.HORIZONTAL, 
            variable=variables['brightness_var'],
            bg='#3c3c3c', 
            fg='white',
            troughcolor='#505050',
            highlightthickness=0
        ...
        tk.Button(
            ...
            command=callbacks['apply_brightness'],
            bg='#007acc', 
            fg='black', 
            activebackground='#005f9e',
            activeforeground='black',
        ...
        contrast_slider = tk.Scale(
            ...
            resolution=0.1, 
            orient=tk.HORIZONTAL,
            variable=variables['contrast_var'], 
            bg='#3c3c3c', 
            fg='white',
            troughcolor='#505050',
            highlightthickness=0
        ...
        tk.Button(
            contrast_frame, 
            text="Apply Contrast", 
            command=callbacks['apply_contrast'],
            bg='#007acc', 
            fg='black', 
            activebackground='#005f9e',
            activeforeground='black',
    ...
    def _setup_transform_tab(notebook, callbacks, variables):
        ...
        for angle, text in [(90, "90°"), (180, "180°"), (270, "270°")]:
            tk.Button(
                ...
                cursor='hand2',
                width=6
            ).pack(side=tk.LEFT, padx=3, expand=True)
        ...
        tk.Button(
            resize_frame, 
            text="Apply Resize", 
            command=callbacks['resize_image'],
            bg='#007acc', 
            fg='black', 
            activebackground='#005f9e',
            activeforeground='black',
